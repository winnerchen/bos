...
<%-- 		<span style="float: right; margin-top: 35px; color: #488ED5;">新BOS系统以宅急送开发的ERP系统为基础，致力于便捷、安全、稳定等方面的客户体验</span> --%>
				...
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							...
							<img id="loginform:vCode"  style="cursor: pointer;" src="${pageContext.request.contextPath }/validatecode.jsp"
								onclick="javascript:document.getElementById('loginform:vCode').src='${pageContext.request.contextPath }/validatecode.jsp?'+Math.random();" />
						</div>
						<a href="javascript:void(0);" onclick="go();" id="loginform:j_id19" name="loginform:j_id19">
						<span
	...
	<div
		...
		</span><span style="float: right; color: #488ED5;">顺风BOS系统</span>
	</div>
</body>
</html>