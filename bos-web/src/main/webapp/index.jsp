...
<script type="text/javascript">
	...
	$(function() {
		...
		window.setTimeout(function(){
			$.messager.show({
				title:"消息提示",
				msg:'欢迎登录，${sessionScope.existUser.email}！ <a href="javascript:void" onclick="top.showAbout();">联系管理员</a>',
				timeout:5000
			});
		},3000);
		/*************/
...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false"
		...
		<div id="sessionInfoDiv"
			...
			[<strong><shiro:principal property="email"></shiro:principal></strong>]，欢迎你！您使用[<strong>${sessionScope.ipAddr}</strong>]IP登录！
		</div>
			...
			<tbody>
				<tr>
					...
					<td style="width: *;" class="co1"><span id="online"
						style="background: url(${pageContext.request.contextPath }/images/online.png) no-repeat left;padding-left:18px;margin-left:3px;font-size:8pt;color:#005590;">在线人数:${applicationScope.count}</span>
					</td>
				</tr>
			</tbody>
		</table>
