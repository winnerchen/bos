 ...
 * Generated at: 2017-07-21 12:42:05 UTC
...
public final class region_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tname: 'upload',//   name  后台接受文件 name值!\r\n");
      out.write("\t\t\taction: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/regionAction_oneClickUpload',//  后台接受文件地址\r\n");
      out.write("\t\t\tenctype: 'multipart/form-data',\r\n");
      out.write("\t\t\t//  autoSubmit: true,//  选择文件立刻提交文件\r\n");
      out.write("\t\t\tonSelect: function() {\r\n");
      out.write("\t\t\t\t//  不要立刻上传文件  判断文件是否是一个 excel文件\r\n");
      out.write("\t\t\t\tthis.autoSubmit = false;\r\n");
      out.write("\t\t\t\t//  判断是否是一个excel文件  正则表达式 ...\r\n");
      out.write("\t\t\t\tvar  re = /^(.+\\.xls|.+\\.xlsx)$/;  //  aa.xls    bb.xlsx\r\n");
      out.write("\t\t\t\tif (re.test(this.filename())) {\r\n");
      out.write("\t\t\t\t\tthis.submit();  // 提交请求\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\telse {\r\n");
      out.write("\t\t\t\t\t$.messager.alert(\"警告!\",\"请上传一个有效excel文件\",\"warning\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t},//  选择文件 该事件触发\r\n");
      out.write("\t\t\tonComplete: function(data) {\r\n");
      out.write("\t\t\t\t//  服务器接受上传文件 之后  回送数据 ajax发送请求完成上传功能\r\n");
      out.write("\t\t\t\t//alert(typeof(data));\r\n");
      out.write("\t\t\t\tvar flag = eval(\"(\" + data + \")\");\r\n");
      out.write("\t\t\t\t//alert(typeof (flag));\r\n");
      out.write("\t\t\t\tif(flag) {\r\n");
      out.write("\t\t\t\t\t$.messager.alert(\"恭喜!\", \"成功!\", \"info\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\telse {\r\n");
      out.write("\t\t\t\t\t$.messager.alert(\"出错了!\", \"上传失败!\", \"error\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$(\"#save\").click(function () {\r\n");
      out.write("\t\t\tvar flag = $(\"#addregionwindow\").form(\"validate\");\r\n");
      out.write("\t\t\tif(flag) {\r\n");
      ...
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tmessage: '区域编码已经存在'\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t});\r\n");
      out.write("\t$.extend($.fn.validatebox.defaults.rules,{\r\n");
      out.write("\t\tuniquePostcode:{\r\n");
      out.write("\t\t\tvalidator: function (value) {\r\n");
      out.write("\t\t\t\tvar flag;\r\n");
      out.write("\t\t\t\t$.ajax({   //  必须采用 原始的$.ajax语法完成ajax的发送\r\n");
      out.write("\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/regionAction_validPostcode',\r\n");
      out.write("\t\t\t\t\ttype : 'POST',\r\n");
      out.write("\t\t\t\t\ttimeout : 60000,\r\n");
      out.write("\t\t\t\t\tdata:{\"postcode\" : value},\r\n");
      out.write("\t\t\t\t\tasync: false,\r\n");
      out.write("\t\t\t\t\tsuccess : function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\t\t\tif (data) {\r\n");
      out.write("\t\t\t\t\t\t\tflag = true;\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"id\" class=\"easyui-validatebox\" required=\"true\"\r\n");
      out.write("\t\t\t\t\t\t\t\t   data-options=\"validType:'uniqueRegionCode'\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>省</td>\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>邮编</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"postcode\" class=\"easyui-validatebox\" required=\"true\"\r\n");
      out.write("\t\t\t\t\t\t\t\t   data-options=\"validType:'uniquePostcode'\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>简码</td>\r\n");
