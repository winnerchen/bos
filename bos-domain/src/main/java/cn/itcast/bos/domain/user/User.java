...
// Generated 2017-7-11 15:34:57 by Hibernate Tools 3.2.2.GA
...
@NamedQuery(name="User.login",query="from User where email=?1 and password=?2")
public class User  implements java.io.Serializable {
	...
	public String toString() {
		return "User [id=" + id + ", email=" + email + ", password=" + password
				+ ", salary=" + salary + ", birthday=" + birthday + ", gender="
				+ gender + ", station=" + station + ", telephone=" + telephone
				+ ", remark=" + remark + "]";
	}
